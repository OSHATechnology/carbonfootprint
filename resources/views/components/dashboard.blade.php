    ...
    <div class="pd-ltr-20">
        <div class="card-box pd-20 height-100-p mb-30">
            <div class="row align-items-center">
                <div class="col-md-4">
                    <img src="{{ asset('assets/vendors') }}/images/banner-img.png" class="w-100" alt="">
                </div>
                <div class="col-md-8">
                    <h4 class="font-30 weight-500 mb-10 text-capitalize">Hallo
                        {{-- <div class="weight-600 font-30 text-green">Carbon Footprint-ers!</div> --}}
                    </h4>
                    <p class="font-18 max-width-600">The following is the calculation of the Carbon Footprint for car
                        production activities. Please input the date, total production output and total energy consumption
                        (BTU)</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-box height-100-p widget-style1">
                        <div class="d-flex flex-wrap align-items-center">
                            <div class="widget-data">
                                ...
                                <div class="weigth-400 font-14" style="text-align:center"><small
                                        class="text-muted">TonsCO2e</small></div>
            ...
            <div class="row">
                <div class="col-md-6 mb-30">
                    <div class="card-box height-100-p pd-20">
                        ...
                        <div id="chartLoadTarget" class="h-100"></div>
                    </div>
                </div>
                <div class="col-md-6 mb-30">
                    <div class="pd-20 card-box height-100-p">
                        <h4 class="h4">Emission Product Comparison</h4>
                        <div id="chart9" class="h-100"></div>
                    </div>
                </div>
            </div>
        </div>
